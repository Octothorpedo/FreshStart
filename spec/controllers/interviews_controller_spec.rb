  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved interview as @interview" do
        ...
        post :create, {:interview => { "description" => "invalid value" }}, valid_session
        assigns(:interview).should be_a_new(Interview)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested interview" do
        ...
        Interview.any_instance.should_receive(:update).with({ "description" => "MyText" })
        put :update, {:id => interview.to_param, :interview => { "description" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the interview as @interview" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Interview.any_instance.stub(:save).and_return(false)
        put :update, {:id => interview.to_param, :interview => { "description" => "invalid value" }}, valid_session
        assigns(:interview).should eq(interview)
      end
